...
export default function SharedWishlistPage(_props: WishlistPageProps) {
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-16 bg-white dark:bg-zinc-800 rounded-xl border border-gray-200 dark:border-zinc-700">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">
            {t('loginRequiredWishlist')}
          </h3>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            {t('loginRequiredWishlistDescription')}
          </p>
          <Link
            href={`/${locale}/login?returnUrl=/${locale}/wishlist`}
            ...
            >
              ...
              <div className="px-4 pb-4">
                <Link
                  ...
                  className="block w-full py-2 text-center text-sm font-medium rounded-lg transition-colors text-white"
                  style={{ backgroundColor: 'var(--store-accent-500)' }}
                >
                  {t('view')}
                </Link>
