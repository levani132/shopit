...
function PendingCouriersContent() {
  ...
  const fetchCouriers = async () => {
    try {
      const data = await api.get<{ couriers: PendingCourier[] }>(
      ...
      setError(
        err instanceof Error ? err.message : 'Failed to fetch pending couriers',
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleApprove = async (courierId: string) => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : 'Failed to approve courier',
      );
    } finally {
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to reject courier');
    } finally {
      setProcessingId(null);
    }
  };
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-4 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    {courier.vehicleType && (
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 bg-cyan-100 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-300 rounded-full">
                        {(() => {
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <button
                    ...
                    disabled={processingId === courier._id}
                    className="px-4 py-2 text-sm bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg transition-colors disabled:opacity-50 flex items-center gap-2"
                  >
          ...
          <div className="bg-white dark:bg-zinc-800 rounded-xl p-6 max-w-md w-full mx-4 shadow-xl">
            ...
            <div className="mt-4">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-300 dark:border-zinc-600 rounded-lg bg-white dark:bg-zinc-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
              />
            </div>
