...
/**
 * Courier subdomain login page - redirects to main site login
 * This page exists because the middleware rewrites couriers.shopit.ge/login 
 * to /couriers/[locale]/login, but we want to use the main site's login.
 */
