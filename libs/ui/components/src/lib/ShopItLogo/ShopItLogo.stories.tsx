...
export const Sizes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'The logo is available in 4 different sizes to fit various use cases.',
      },
    },
  },
};
...
export const Variants: Story = {
  render: () => (
    <div className="flex flex-col gap-6">
      <div className="p-4 bg-white rounded-lg border">
        <span className="text-xs text-gray-500 block mb-2">Auto (follows theme)</span>
        <ShopItLogo variant="auto" size="lg" />
      </div>
      <div className="p-4 bg-gray-900 rounded-lg">
        <span className="text-xs text-gray-400 block mb-2">Light (for dark backgrounds)</span>
        <ShopItLogo variant="light" size="lg" />
      </div>
      <div className="p-4 bg-gray-100 rounded-lg">
        <span className="text-xs text-gray-500 block mb-2">Dark (for light backgrounds)</span>
  ...
  parameters: {
    docs: {
      description: {
        story: 'Use `auto` for theme-following, `light` for dark backgrounds, and `dark` for light backgrounds.',
      },
    },
  },
};
  ...
  render: () => (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        <span className="text-sm font-medium text-gray-600">With Text (default)</span>
...
export const IconOnly: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'The ShopItIcon component is a standalone icon for favicons, app icons, and space-constrained layouts.',
      },
    },
  },
};
...
export const HeaderExample: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Example of how the logo appears in a typical header navigation.',
      },
    },
  },
};
...
export const DarkModeExample: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Use the `light` variant when displaying the logo on dark backgrounds.',
      },
    },
  },
};
...
export const FooterExample: Story = {
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          <div className="flex gap-12">
            <div className="flex flex-col gap-2">
              ...
              <span className="text-gray-400 text-sm hover:text-white cursor-pointer">About</span>
              <span className="text-gray-400 text-sm hover:text-white cursor-pointer">Careers</span>
              <span className="text-gray-400 text-sm hover:text-white cursor-pointer">Contact</span>
            </div>
            <div className="flex flex-col gap-2">
              <span className="text-white font-medium text-sm">Legal</span>
              <span className="text-gray-400 text-sm hover:text-white cursor-pointer">Privacy</span>
              <span className="text-gray-400 text-sm hover:text-white cursor-pointer">Terms</span>
            </div>
          </div>
        </div>
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Example of the logo in a footer context with the light variant.',
      },
    },
  },
};
